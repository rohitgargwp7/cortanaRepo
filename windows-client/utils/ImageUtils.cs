...
namespace windows_client.utils
{
    public class UI_Utils
    {
        ...
        public BitmapImage MuteIconForConversationView
        {
            get
            {
                ...
                {
                    if (Utils.isDarkTheme())
                        muteIconForConversationView = new BitmapImage(new Uri("/View/images/unmute_icon_main_w.png", UriKind.Relative));
                    else
                        muteIconForConversationView = new BitmapImage(new Uri("/View/images/unmute_icon_main_b.png", UriKind.Relative));
                }
    ...
    public class DirectionImageUtils
    {
        public BitmapImage InstructionKindEnd
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindEndLight == null)
                        instructionKindEndLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindEndLight;
                }
                else
                {
                    if (instructionKindEndDark == null)
                        instructionKindEndDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindEndDark;
                }
            }
        }

        public BitmapImage InstructionKindFreewayContinueLeft
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindFreewayContinueLeftLight == null)
                        instructionKindFreewayContinueLeftLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindFreewayContinueLeftLight;
                }
                else
                {
                    if (instructionKindFreewayContinueLeftDark == null)
                        instructionKindFreewayContinueLeftDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindFreewayContinueLeftDark;
                }
            }
        }

        public BitmapImage InstructionKindFreewayContinueRight
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindFreewayContinueRightLight == null)
                        instructionKindFreewayContinueRightLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindFreewayContinueRightLight;
                }
                else
                {
                    if (instructionKindFreewayContinueRightDark == null)
                        instructionKindFreewayContinueRightDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindFreewayContinueRightDark;
                }
            }
        }

        public BitmapImage InstructionKindFreewayEnterLeft
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindFreewayEnterLeftLight == null)
                        instructionKindFreewayEnterLeftLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindFreewayEnterLeftLight;
                }
                else
                {
                    if (instructionKindFreewayEnterLeftDark == null)
                        instructionKindFreewayEnterLeftDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindFreewayEnterLeftDark;
                }
            }
        }

        public BitmapImage InstructionKindFreewayEnterRight
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindFreewayEnterRightLight == null)
                        instructionKindFreewayEnterRightLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindFreewayEnterRightLight;
                }
                else
                {
                    if (instructionKindFreewayEnterRightDark == null)
                        instructionKindFreewayEnterRightDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindFreewayEnterRightDark;
                }
            }
        }

        public BitmapImage InstructionKindFreewayLeaveLeft
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindFreewayLeaveLeftLight == null)
                        instructionKindFreewayLeaveLeftLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindFreewayLeaveLeftLight;
                }
                else
                {
                    if (instructionKindFreewayLeaveLeftDark == null)
                        instructionKindFreewayLeaveLeftDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindFreewayLeaveLeftDark;
                }
            }
        }

        public BitmapImage InstructionKindFreewayLeaveRight
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindFreewayLeaveRightLight == null)
                        instructionKindFreewayLeaveRightLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindFreewayLeaveRightLight;
                }
                else
                {
                    if (instructionKindFreewayLeaveRightDark == null)
                        instructionKindFreewayLeaveRightDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindFreewayLeaveRightDark;
                }
            }
        }

        public BitmapImage InstructionKindGoStraight
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindGoStraightLight == null)
                        instructionKindGoStraightLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindGoStraightLight;
                }
                else
                {
                    if (instructionKindGoStraightDark == null)
                        instructionKindGoStraightDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindGoStraightDark;
                }
            }
        }

        public BitmapImage InstructionKindStart
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindStartLight == null)
                        instructionKindStartLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindStartLight;
                }
                else
                {
                    if (instructionKindStartDark == null)
                        instructionKindStartDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindStartDark;
                }
            }
        }

        public BitmapImage InstructionKindStopover
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindStopoverLight == null)
                        instructionKindStopoverLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindStopoverLight;
                }
                else
                {
                    if (instructionKindStopoverDark == null)
                        instructionKindStopoverDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindStopoverDark;
                }
            }
        }

        public BitmapImage InstructionKindStopoverResume
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindStopoverResumeLight == null)
                        instructionKindStopoverResumeLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindStopoverResumeLight;
                }
                else
                {
                    if (instructionKindStopoverResumeDark == null)
                        instructionKindStopoverResumeDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindStopoverResumeDark;
                }
            }
        }

        public BitmapImage InstructionKindTakeFerry
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindTakeFerryLight == null)
                        instructionKindTakeFerryLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindTakeFerryLight;
                }
                else
                {
                    if (instructionKindTakeFerryDark == null)
                        instructionKindTakeFerryDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindTakeFerryDark;
                }
            }
        }

        public BitmapImage InstructionKindTrafficCircleLeft
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindTrafficCircleLeftLight == null)
                        instructionKindTrafficCircleLeftLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindTrafficCircleLeftLight;
                }
                else
                {
                    if (instructionKindTrafficCircleLeftDark == null)
                        instructionKindTrafficCircleLeftDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindTrafficCircleLeftDark;
                }
            }
        }

        public BitmapImage InstructionKindTrafficCircleRight
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindTrafficCircleRightLight == null)
                        instructionKindTrafficCircleRightLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindTrafficCircleRightLight;
                }
                else
                {
                    if (instructionKindTrafficCircleRightDark == null)
                        instructionKindTrafficCircleRightDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindTrafficCircleRightDark;
                }
            }
        }

        public BitmapImage InstructionKindTurnHardLeft
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindTurnHardLeftLight == null)
                        instructionKindTurnHardLeftLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindTurnHardLeftLight;
                }
                else
                {
                    if (instructionKindTurnHardLeftDark == null)
                        instructionKindTurnHardLeftDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindTurnHardLeftDark;
                }
            }
        }

        public BitmapImage InstructionKindTurnHardRight
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindTurnHardRightLight == null)
                        instructionKindTurnHardRightLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindTurnHardRightLight;
                }
                else
                {
                    if (instructionKindTurnHardRightDark == null)
                        instructionKindTurnHardRightDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindTurnHardRightDark;
                }
            }
        }

        public BitmapImage InstructionKindTurnKeepLeft
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindTurnKeepLeftLight == null)
                        instructionKindTurnKeepLeftLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindTurnKeepLeftLight;
                }
                else
                {
                    if (instructionKindTurnKeepLeftDark == null)
                        instructionKindTurnKeepLeftDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindTurnKeepLeftDark;
                }
            }
        }

        public BitmapImage InstructionKindTurnKeepRight
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindTurnKeepRightLight == null)
                        instructionKindTurnKeepRightLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindTurnKeepRightLight;
                }
                else
                {
                    if (instructionKindTurnKeepRightDark == null)
                        instructionKindTurnKeepRightDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindTurnKeepRightDark;
                }
            }
        }

        public BitmapImage InstructionKindTurnLeft
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindTurnLeftLight == null)
                        instructionKindTurnLeftLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindTurnLeftLight;
                }
                else
                {
                    if (instructionKindTurnLeftDark == null)
                        instructionKindTurnLeftDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindTurnLeftDark;
                }
            }
        }

        public BitmapImage InstructionKindTurnLightRight
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindTurnLightRightLight == null)
                        instructionKindTurnLightRightLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindTurnLightRightLight;
                }
                else
                {
                    if (instructionKindTurnLightRightDark == null)
                        instructionKindTurnLightRightDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindTurnLightRightDark;
                }
            }
        }

        public BitmapImage InstructionKindTurnRight
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindTurnRightLight == null)
                        instructionKindTurnRightLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindTurnRightLight;
                }
                else
                {
                    if (instructionKindTurnRightDark == null)
                        instructionKindTurnRightDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindTurnRightDark;
                }
            }
        }

        public BitmapImage InstructionKindTurnLightLeft
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindTurnLightLeftLight == null)
                        instructionKindTurnLightLeftLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindTurnLightLeftLight;
                }
                else
                {
                    if (instructionKindTurnLightLeftDark == null)
                        instructionKindTurnLightLeftDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindTurnLightLeftDark;
                }
            }
        }

        public BitmapImage InstructionKindUndefined
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindUndefinedLight == null)
                        instructionKindUndefinedLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindUndefinedLight;
                }
                else
                {
                    if (instructionKindUndefinedDark == null)
                        instructionKindUndefinedDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindUndefinedDark;
                }
            }
        }

        public BitmapImage InstructionKindUTurnLeft
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindUTurnLeftLight == null)
                        instructionKindUTurnLeftLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindUTurnLeftLight;
                }
                else
                {
                    if (instructionKindUTurnLeftDark == null)
                        instructionKindUTurnLeftDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindUTurnLeftDark;
                }
            }
        }

        public BitmapImage InstructionKindUTurnRight
        {
            get
            {
                if (Utils.isDarkTheme())
                {
                    if (instructionKindUTurnRightLight == null)
                        instructionKindUTurnRightLight = new BitmapImage(new Uri("/View/images/deleted_grey_icon.png", UriKind.Relative));

                    return instructionKindUTurnRightLight;
                }
                else
                {
                    if (instructionKindUTurnRightDark == null)
                        instructionKindUTurnRightDark = new BitmapImage(new Uri("/View/images/deleted_white_icon.png", UriKind.Relative));

                    return instructionKindUTurnRightDark;
                }
            }
        }

        BitmapImage instructionKindEndLight;
        BitmapImage instructionKindEndDark;
        BitmapImage instructionKindFreewayContinueLeftDark;
        BitmapImage instructionKindFreewayContinueLeftLight;
        BitmapImage instructionKindFreewayContinueRightLight;
        BitmapImage instructionKindFreewayContinueRightDark;
        BitmapImage instructionKindTurnKeepRightLight;
        BitmapImage instructionKindTurnKeepRightDark;
        BitmapImage instructionKindTurnLeftDark;
        BitmapImage instructionKindTurnLeftLight;
        BitmapImage instructionKindTurnRightLight;
        BitmapImage instructionKindTurnRightDark;
        BitmapImage instructionKindTurnLightRightLight;
        BitmapImage instructionKindTurnLightRightDark;
        BitmapImage instructionKindTurnHardLeftLight;
        BitmapImage instructionKindTurnHardLeftDark;
        BitmapImage instructionKindTurnHardRightLight;
        BitmapImage instructionKindTurnHardRightDark;
        BitmapImage instructionKindTurnKeepLeftLight;
        BitmapImage instructionKindTurnKeepLeftDark;
        BitmapImage instructionKindTrafficCircleLeftLight;
        BitmapImage instructionKindTrafficCircleLeftDark;
        BitmapImage instructionKindTrafficCircleRightLight;
        BitmapImage instructionKindTrafficCircleRightDark;
        BitmapImage instructionKindGoStraightLight;
        BitmapImage instructionKindGoStraightDark;
        BitmapImage instructionKindStartLight;
        BitmapImage instructionKindStartDark;
        BitmapImage instructionKindTakeFerryDark;
        BitmapImage instructionKindTakeFerryLight;
        BitmapImage instructionKindStopoverResumeDark;
        BitmapImage instructionKindStopoverResumeLight;
        BitmapImage instructionKindStopoverDark;
        BitmapImage instructionKindStopoverLight;
        BitmapImage instructionKindFreewayEnterRightLight;
        BitmapImage instructionKindFreewayEnterRightDark;
        BitmapImage instructionKindFreewayLeaveLeftLight;
        BitmapImage instructionKindFreewayLeaveLeftDark;
        BitmapImage instructionKindFreewayLeaveRightLight;
        BitmapImage instructionKindFreewayLeaveRightDark;
        BitmapImage instructionKindFreewayEnterLeftLight;
        BitmapImage instructionKindFreewayEnterLeftDark;
        BitmapImage instructionKindUndefinedLight;
        BitmapImage instructionKindUndefinedDark;
        BitmapImage instructionKindUTurnLeftLight;
        BitmapImage instructionKindUTurnLeftDark;
        BitmapImage instructionKindTurnLightLeftLight;
        BitmapImage instructionKindTurnLightLeftDark;
        BitmapImage instructionKindUTurnRightLight;
        BitmapImage instructionKindUTurnRightDark;

        public static DirectionImageUtils Instance
        {
            get
            {
                if (instance == null)
                {
                    lock (syncRoot)
                    {
                        if (instance == null)
                        {
                            instance = new DirectionImageUtils();
                        }
                    }
                }
                return instance;
        ...
        private static volatile DirectionImageUtils instance = null;
