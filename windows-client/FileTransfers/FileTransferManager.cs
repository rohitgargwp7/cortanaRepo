    ...
    public class FileTransferManager
    {
        ...
        void PopulateUploads()
        {
            lock (readWriteLock)
            {
                ...
                {
                    Logging.LogWriter.Instance.WriteToLog("FileTransferManager :: Load Uploads From File, Exception : " + ex.StackTrace);
                }
            }
        }
        ...
        void PopulateDownloads()
        {
            lock (readWriteLock)
            {
                ...
                {
                    Logging.LogWriter.Instance.WriteToLog("FileTransferManager :: Load Downloads From File, Exception : " + ex.StackTrace);
                }
            }
        }
