        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.NavigationMode == NavigationMode.New || App.IS_TOMBSTONED)
            {
                ...
                bw.DoWork += (a, b) =>
                {
                    ...
                    if (Utils.compareVersion("2.5.2.3", App.CURRENT_VERSION) == 1)
                    ...
                    if (Utils.compareVersion("2.5.2.3", App.CURRENT_VERSION) == 1)
                    {
                        ...
                        if (Utils.compareVersion("2.5.2.3", App.CURRENT_VERSION) == 1) // upgrade friend files for last seen time stamp
                        ...
                        using (HikeChatsDb db = new HikeChatsDb(App.MsgsDBConnectionstring))
                        {
                            if (db.DatabaseExists())
                            {
                                ...
                                if (version < 3)  
                                {
                                    ...
                                    {
                                        Debug.WriteLine("db not upgrade in v 2.5.2.3");
                                    }
                                }
                            }
                        }
