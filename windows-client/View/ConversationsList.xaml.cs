...
namespace windows_client.View
{
    public partial class ConversationsList : PhoneApplicationPage, HikePubSub.Listener
    {
        ...
        public ConversationsList()
        {
            ...
            HikeInstantiation.RemoveKeyFromAppSettings(AppSettingsKeys.PHONE_ADDRESS_BOOK);
            ...
            int tipCount;
            HikeInstantiation.AppSettings.TryGetValue(AppSettingsKeys.PRO_TIP_COUNT, out tipCount);
            ...
            appSettings.TryGetValue(AppSettingsKeys.ACCOUNT_NAME, out _userName);

            _firstName = Utils.GetFirstName(_userName);
            string password = HikeInstantiation.ViewModel.Password;
            HikeInstantiation.AppSettings.TryGetValue(AppSettingsKeys.HIDDEN_MODE_PASSWORD, out password);
            HikeInstantiation.ViewModel.Password = password;
            HikeInstantiation.AppSettings.TryGetValue(AppSettingsKeys.HIDDEN_TOOLTIP_STATUS, out _tipMode);
        ...
        protected override void OnNavigatedTo(System.Windows.Navigation.NavigationEventArgs e)
        {
            ...
            byte statusSettingsValue;
            _isStatusUpdatesNotMute = HikeInstantiation.AppSettings.TryGetValue(AppSettingsKeys.STATUS_UPDATE_SETTING, out statusSettingsValue) && statusSettingsValue == 0;
        ...
        private void loadingCompleted()
        {
            ...
            if (HikeInstantiation.AppSettings.Contains(AppSettingsKeys.IS_NEW_INSTALLATION) || HikeInstantiation.AppSettings.Contains(AppSettingsKeys.NEW_UPDATE))
            {
                if (HikeInstantiation.AppSettings.Contains(AppSettingsKeys.IS_NEW_INSTALLATION))
                ...
                HikeInstantiation.RemoveKeyFromAppSettings(AppSettingsKeys.IS_NEW_INSTALLATION);
                HikeInstantiation.RemoveKeyFromAppSettings(AppSettingsKeys.NEW_UPDATE);
            }
        }
        ...
        private void ShowFTUECards()
        {
            ...
            if (peopleOnHikeListBox.ItemsSource == null)
            {
                ...
                HikeInstantiation.AppSettings.TryGetValue(AppSettingsKeys.CONTACTS_TO_SHOW, out contacts);
        ...
        private void initAppBar()
        {
            ...
            byte statusSettingsValue;
            if (!HikeInstantiation.AppSettings.TryGetValue(AppSettingsKeys.STATUS_UPDATE_SETTING, out statusSettingsValue)) // settings dont exist on new sign up, hence on by default
            ...
            bool showRewards;
            if (HikeInstantiation.AppSettings.TryGetValue<bool>(ServerJsonKeys.SHOW_REWARDS, out showRewards) && showRewards == true)
            {
        ...
        void rewardsMenu_Click(object sender, EventArgs e)
        {
            ...
            if (!HikeInstantiation.AppSettings.Contains(ServerJsonKeys.REWARDS_TOKEN))
                return;
        ...
        void muteStatusMenu_Click(object sender, EventArgs e)
        {
            ...
            data.Add(ServerJsonKeys.PUSH_SU, settingsValue);
        ...
        void DeleteConversation(ConversationListObject convObj, bool sendHiddenChatToogledPacket)
        {
            ...
            if (Utility.IsGroupConversation(convObj.Msisdn))
            {
                ...
                jObj[ServerJsonKeys.TO] = convObj.Msisdn;
        ...
        public void onEventReceived(string type, object obj)
        {
            ...
            if (HikePubSub.MESSAGE_RECEIVED == type)
            {
                ...
                if (HikeInstantiation.NewChatThreadPageObj == null && showPush && (!Utility.IsGroupConversation(mObj.Msisdn) || !mObj.IsMute) && Utils.ShowNotificationAlert())
                {
                    ...
                    appSettings[AppSettingsKeys.LAST_NOTIFICATION_TIME] = DateTime.Now.Ticks;
                }
            }
            #endregion
            ...
            {
                bool showRewards;
                appSettings.TryGetValue(ServerJsonKeys.SHOW_REWARDS, out showRewards);
        ...
        private void ShowChats()
        {
            ...
            if (HikeInstantiation.AppSettings.Contains(AppSettingsKeys.HIDDEN_TOOLTIP_STATUS))
                UpdateToolTip(true);
        }
        ...
        {
            String updateObj;
            if (HikeInstantiation.AppSettings.TryGetValue(AppSettingsKeys.NEW_UPDATE_AVAILABLE, out updateObj))
            {
                ...
                var message = (string)obj[ServerJsonKeys.TEXT_UPDATE_MSG];
                bool isCriticalUpdate = (bool)obj[ServerJsonKeys.CRITICAL];
        ...
        private void MenuItem_Click_AddRemoveFav(object sender, RoutedEventArgs e)
        {
            ...
            if (convObj.IsFav) // already fav , remove request
            {
                ...
                JObject obj = new JObject();
                obj[ServerJsonKeys.TYPE] = ServerJsonKeys.MqttMessageTypes.REMOVE_FAVOURITE;
        ...
        private void checkForRateApp()
        {
            ...
            if (HikeInstantiation.AppSettings.TryGetValue(AppSettingsKeys.APP_LAUNCH_COUNT, out appLaunchCount) && appLaunchCount > 0)
            {
                ...
                HikeInstantiation.WriteToIsoStorageSettings(AppSettingsKeys.APP_LAUNCH_COUNT, appLaunchCount + 1);
            }
        }
                         ...
                         if (returned != null)
                         {
                             if (returned == 0)
                             {
                                 ...
                                 try
                                 {
                                     ...
                                     HikeInstantiation.AppSettings.Remove(AppSettingsKeys.APP_LAUNCH_COUNT);
                                 }
                                 catch (Exception ex)
                                 {
        ...
        private int ProTipCount
        {
            ...
            set
            {
                if (value != _proTipCount)
                {
                    ...
                    _proTipCount = value;
                    HikeInstantiation.WriteToIsoStorageSettings(AppSettingsKeys.PRO_TIP_COUNT, value);
                }
            }
        }
        ...
        private void dismissProTip_Click(object sender, RoutedEventArgs e)
        {
            ...
            HikeInstantiation.WriteToIsoStorageSettings(AppSettingsKeys.PRO_TIP_LAST_DISMISS_TIME, DateTime.Now);
            ...
            worker.DoWork += (ss, ee) =>
                {
                    if (HikeInstantiation.AppSettings.Contains(AppSettingsKeys.PRO_TIP))
                    {
        ...
        void ShowInvitePopups()
        {
            ...
            if (HikeInstantiation.AppSettings.TryGetValue(AppSettingsKeys.SHOW_POPUP, out obj))
            {
        ...
        void customOverlay_VisibilityChanged(object sender, EventArgs e)
        {
            ...
            if (overlay.Visibility == Visibility.Collapsed)
            {
                ...
                ApplicationBar.IsMenuEnabled = true;
                launchPagePivot.IsHitTestVisible = true;
                HikeInstantiation.RemoveKeyFromAppSettings(AppSettingsKeys.SHOW_POPUP);
            }
            else
            {
                foreach (ApplicationBarIconButton button in appBar.Buttons)
        ...
        private void hikeLogo_Tapped(object sender, System.Windows.Input.GestureEventArgs e)
        {
            ...
            else
            {
                ...
                if (!HikeInstantiation.ViewModel.IsHiddenModeActive)
                {
                    ...
                    passwordOverlay.Text = HikeInstantiation.AppSettings.Contains(AppSettingsKeys.HIDDEN_MODE_PASSWORD) ?
                ...
                else
                {
                    ...
                    if (HikeInstantiation.AppSettings.Contains(AppSettingsKeys.HIDDEN_TOOLTIP_STATUS) && _tipMode == ToolTipMode.HIDDEN_MODE_COMPLETE)
                    {
                        HikeInstantiation.RemoveKeyFromAppSettings(AppSettingsKeys.HIDDEN_TOOLTIP_STATUS);
        ...
        {
            if (HikeInstantiation.AppSettings.Contains(AppSettingsKeys.HIDDEN_TOOLTIP_STATUS) && _tipMode == ToolTipMode.HIDDEN_MODE_STEP2)
                conversationPageToolTip.IsShow = false;
        ...
        void SendHiddenModeToggledPacket()
        {
            ...
            hideObj.Add(ServerJsonKeys.TYPE, ServerJsonKeys.HIDDEN_MODE_TYPE);

            JObject data = new JObject();

            if (HikeInstantiation.AppSettings.Contains(AppSettingsKeys.HIDDEN_MODE_ACTIVATED))
                data.Add(ServerJsonKeys.HIDDEN_MODE_ENABLED, true);

            else
                data.Add(ServerJsonKeys.HIDDEN_MODE_ENABLED, false);
        ...
        private void MenuItem_Click_HideChat(object sender, RoutedEventArgs e)
        {
            ...
            if (obj != null)
            {
                ...
                if (obj.IsHidden)
                    data.Add(ServerJsonKeys.CHAT_ENABLED, msisdn);
                else
        ...
        {
            long resetTime;
            if (HikeInstantiation.AppSettings.TryGetValue<long>(AppSettingsKeys.HIDDEN_MODE_RESET_TIME, out resetTime))
            {
        ...
        void UpdateToolTip(bool isModeChanged)
        {
            ...
            if (_tipMode != ToolTipMode.DEFAULT)
            {
                ...
                HikeInstantiation.WriteToIsoStorageSettings(AppSettingsKeys.HIDDEN_TOOLTIP_STATUS, _tipMode);
            }
            else if (HikeInstantiation.AppSettings.Contains(AppSettingsKeys.HIDDEN_TOOLTIP_STATUS))
                HikeInstantiation.RemoveKeyFromAppSettings(AppSettingsKeys.HIDDEN_TOOLTIP_STATUS);
        }
        ...
        void conversationPageToolTip_FullTipTapped(object sender, EventArgs e)
        {
            switch (_tipMode)
            {
                case ToolTipMode.RESET_HIDDEN_MODE_COMPLETED:
                    ...
                    HikeInstantiation.RemoveKeyFromAppSettings(AppSettingsKeys.HIDDEN_MODE_RESET_TIME);
        ...
        private void RemoveHiddenModePassword()
        {
            ...
            HikeInstantiation.RemoveKeyFromAppSettings(AppSettingsKeys.HIDDEN_MODE_PASSWORD);
        }
        ...
        void SendResetPacketToServer()
        {
            ...
            JObject data = new JObject();
            data.Add(ServerJsonKeys.RESET, true);
