...
namespace windows_client.View
{
    public partial class NewGroup : PhoneApplicationPage
    {
        ...
        void photoChooserTask_Completed(object sender, PhotoResult e)
        {
            ...
            if (e.TaskResult == TaskResult.OK)
            {
                ...
                try
                {
                    ...
                    PhoneApplicationService.Current.State[HikeConstants.NavigationKeys.HAS_CUSTOM_IMAGE] = true;
                }
                catch (Exception ex)
                {
        ...
        private void Next_Click(object sender, EventArgs e)
        {
            ...
            PhoneApplicationService.Current.State[HikeConstants.NavigationKeys.GROUP_NAME] = group_name;
            PhoneApplicationService.Current.State[HikeConstants.NavigationKeys.NEW_GROUP_ID] = mContactNumber;
        ...
        protected override void OnNavigatedTo(System.Windows.Navigation.NavigationEventArgs e)
        {
            ...
            if (e.NavigationMode == System.Windows.Navigation.NavigationMode.New || HikeInstantiation.IsTombstoneLaunch)
            {
                ...
                {
                    if (State.TryGetValue(HikeConstants.NavigationKeys.GROUP_NAME, out obj))
                    {
