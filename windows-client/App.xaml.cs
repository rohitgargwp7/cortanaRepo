    ...
    public partial class App : Application
    {
        ...
        void RootFrame_Navigating(object sender, NavigatingCancelEventArgs e)
        {
            ...
            */
            ...
            if (!isNewInstall && Utils.compareVersion("2.2.0.7", _currentVersion) == 1 && Utils.IsWP8)
            {
        ...
        private static void instantiateClasses(bool initInUpgradePage)
        {
            ...
            if (!isNewInstall && Utils.compareVersion(_currentVersion, "2.2.0.7") < 0)
            {
                try
                {
                    byte value;
            ...
            if (isNewInstall || Utils.compareVersion("2.2.0.7", _currentVersion) == 1)
            {
