    ...
    public partial class App : Application
    {
        ...
        void RootFrame_Navigating(object sender, NavigatingCancelEventArgs e)
        {
            ...
            */
            ...
            if (!String.IsNullOrEmpty(_currentVersion) && Utils.compareVersion("2.5.3.7", _currentVersion) == 1)
            {
        ...
        private static void instantiateClasses(bool initInUpgradePage)
        {
            ...
            #endregion
            #region STCIKERS
            if (isNewInstall || Utils.compareVersion(_currentVersion, "2.5.3.7") < 0)
            {
            ...
            #endregion
            #region TUTORIAL
            if (!isNewInstall && Utils.compareVersion("2.5.3.7", _currentVersion) == 1)
            {
            ...
            #endregion
            #region CHAT_FTUE
            if (!isNewInstall && Utils.compareVersion(_currentVersion, "2.5.3.7") < 0)//if it is upgrade
