...
namespace windows_client
{
    public partial class App : Application
    {
        ...
        private static void instantiateClasses(bool initInUpgradePage)
        {
            ...
            else if (Utils.compareVersion(_currentVersion, "2.4.0.5") < 0)
            {
            ...
            #endregion
            #region STCIKERS
            if (isNewInstall || Utils.compareVersion(_currentVersion, "2.4.0.5") < 0)
            {
            ...
            if (_viewModel == null)
            {
                ...
                if (!isNewInstall && Utils.compareVersion(_latestVersion, _currentVersion) == 1) // shows this is update
                {
                    ...
                    if (Utils.compareVersion(_currentVersion, "2.4.0.5") < 0)
