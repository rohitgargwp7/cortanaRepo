...
namespace FileTransfer
{
    public class FileTransferManager
    {
        ...
        void FailTask(FileInfoBase fInfo)
        {
            ...
            var args = new FileTransferSatatusChangedEventArgs(fInfo, true);

            if (UpdateTaskStatusOnUI != null)
                UpdateTaskStatusOnUI(null, args);

            if(TriggerPubSub != null)
                TriggerPubSub(null, args);
        }
        ...
        private void NotifyUI(FileTransferSatatusChangedEventArgs e)
        {
            ...
            if (e.IsStateChanged && TriggerPubSub != null)
                TriggerPubSub(null, e);
        ...
        public event EventHandler<FileTransferSatatusChangedEventArgs> TriggerPubSub;
    }
