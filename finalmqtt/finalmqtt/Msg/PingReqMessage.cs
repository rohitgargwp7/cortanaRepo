...
{
    public class PingReqMessage : Message
    {
        public PingReqMessage(MqttConnection conn)
            : base(MessageType.PINGREQ, conn)
        {
        }

        public PingReqMessage(Header header, MqttConnection conn)
            : base(header, conn)
        {
        }
